.const bitmapDataAddress = $3800
.const screenData = $4000
.const screenColorData = screenData + 1000//$3be8
// 10 sys2061
:BasicUpstart2(start)
...
start:
	...
	lda #%00011111
	sta $d018
	/*dependecies between content of $d018 and character bitmap offset:
	    $d018    |offset
	    xxxx1000 |$2000
	    xxxx1001 |$2000
	    xxxx1010 |$2800
...
.print "End bitmap data: $" + toHexString(*) + " [" + * + "]"
